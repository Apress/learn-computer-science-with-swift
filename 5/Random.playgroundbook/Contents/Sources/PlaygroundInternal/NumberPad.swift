...
class NumberPad: UIControl {
    ...
    private func updateSwipeActions() {
        ...
        if allowsFloats {
            let decimalAxText = NSLocalizedString("com.apple.playgroundbook.template.Answers.decimal-button", value: "Insert decimal point", comment: "Accessibility text for the decimal button")
            swipeButton.setPrimaryActionImage(UIImage(named: "Decimal"), accessibilityDescription: decimalAxText)
            
            let signAxText = NSLocalizedString("com.apple.playgroundbook.template.Answers.change-sign-button", value: "Change number's sign", comment: "Accessibility text for the number sign change button")
...
extension UIControlEvents {
    public static var secondaryActionTriggered: UIControlEvents {
